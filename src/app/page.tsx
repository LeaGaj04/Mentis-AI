      ...
      <main className="flex-1 flex flex-col items-center z-10 px-4 pb-24">
        ...
        <section className="w-full max-w-5xl mt-20 md:mt-32 flex flex-col items-center text-center gap-6">
          <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-calm-100/50 dark:bg-calm-900/30 text-calm-700 dark:text-calm-300 text-sm font-medium border border-calm-200/50 dark:border-calm-800/50 backdrop-blur-sm shadow-sm">
            <Heart className="w-4 h-4" /> La próxima generación de apoyo emocional
          </div>
          <h2 className="text-5xl md:text-7xl font-extrabold tracking-tight text-mist-900 dark:text-white drop-shadow-sm max-w-4xl leading-tight">
            Descubre una nueva forma de <br className="hidden md:block"/>
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-calm-500 to-warmth-400 dark:from-calm-400 dark:to-warmth-300">explorar tu mente</span>
          </h2>
          <p className="text-lg md:text-xl text-mist-600 dark:text-mist-300 max-w-2xl mt-2 font-medium">
        ...
        <section className="w-full max-w-5xl mt-32 grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="flex flex-col items-center justify-center p-8 rounded-3xl bg-white/60 dark:bg-mist-900/60 backdrop-blur-md border border-calm-200/50 dark:border-calm-800/50 shadow-xl shadow-calm-200/20 dark:shadow-none transition-transform hover:-translate-y-1 duration-300">
            ...
            <span className="text-4xl font-black text-mist-900 dark:text-white mb-2">+10,000</span>
          ...
          <div className="flex flex-col items-center justify-center p-8 rounded-3xl bg-white/60 dark:bg-mist-900/60 backdrop-blur-md border border-calm-200/50 dark:border-calm-800/50 shadow-xl shadow-calm-200/20 dark:shadow-none transition-transform hover:-translate-y-1 duration-300 delay-75">
            <MessageSquareHeart className="w-10 h-10 text-warmth-400 dark:text-warmth-300 mb-4" />
            <span className="text-4xl font-black text-mist-900 dark:text-white mb-2">+500k</span>
          ...
          <div className="flex flex-col items-center justify-center p-8 rounded-3xl bg-white/60 dark:bg-mist-900/60 backdrop-blur-md border border-calm-200/50 dark:border-calm-800/50 shadow-xl shadow-calm-200/20 dark:shadow-none transition-transform hover:-translate-y-1 duration-300 delay-150">
            <ShieldCheck className="w-10 h-10 text-sage-500 dark:text-sage-400 mb-4" />
            <span className="text-4xl font-black text-mist-900 dark:text-white mb-2">100%</span>
        ...
        <section className="w-full max-w-5xl mt-32 flex flex-col gap-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            <div className="order-2 md:order-1">
              ...
              <ul className="space-y-4 text-mist-700 dark:text-mist-300 font-medium">
